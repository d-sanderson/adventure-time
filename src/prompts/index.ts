...
`,
  choice: (choice: string, previousPrompt: string) => `The player selected ${choice}. Continue the telling the story, the last prompt was ${previousPrompt}. Return at least 4 choices. Continue the story and remember that it takes place in the Meow Wolf universe.
